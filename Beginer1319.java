...
public class Beginer1319 extends JFrame implements ActionListener {

    JButton diet, workout, bmi, info, back, updateinfo;
    String username, age, height, weight;

    Beginer1319(String username) {
        ...
        uname.setBounds(110, 5, 250, 100);
        uname.setForeground(new Color(147, 215, 11));
        uname.setFont(new Font("SAN_SERIF", Font.BOLD, 40));
        jp1.add(uname);
